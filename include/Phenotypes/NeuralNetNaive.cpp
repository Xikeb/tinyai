...
#include "IPhenotype.hpp"
#include "NeuralNetNaive.hpp"

namespace ann {
    void NeuralNetNaive::from_genome(const neat::Genotype &a) {
    ...
    void NeuralNetNaive::evaluate(const std::vector<double> &input, std::vector<double> &output) {
        ...
        while (!s.empty()) {
            ...
            if (nodes[nodeId].visited) {
                ...
                nodes[nodeId].value = ann::sigmoid(sum);
                s.pop();
            } else {
    ...
    void NeuralNetNaive::import_fromfile(std::string const &filename) {
        std::ifstream o;
        o.open(filename);
    ...
    void NeuralNetNaive::export_tofile(std::string const &filename) {
        std::ofstream o;
        o.open(filename);
